...
import { QrCode, Zap, Palette, History, TrendingUp, Shield, Download, Smartphone } from "lucide-react";
      ...
      <section className="relative overflow-hidden bg-gradient-hero py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10">
            Generate, customize, and track QR codes with powerful features.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Powerful features to create professional QR codes for any use case
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => {
              ...
              return (
                <Card key={feature.title} className="shadow-card border-border/50 hover:shadow-elegant transition-all hover:-translate-y-1">
                  <CardHeader>
